...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        // `data-[size=default]:h-11` keeps the trigger at the ~44px mobile
        // touch-target floor, consistent with `Input` / `Button` `default`
        // (Story 1.6 Task 6). `sm` stays compact for dense pointer-first UIs.
